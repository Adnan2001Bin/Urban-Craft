...
import img1 from '/public/assets/Artistic Furniture/Artistic_Small6_785x464.jpg'
import img2 from '/public/assets/Artistic Furniture/Artistic_Small5_785x464.jpg'
import img3 from '/public/assets/Artistic Furniture/Artistic_Small4_785x464.jpg'

const ArtisticFurniture1 = () => {
    ...
    return (
        <div className="backgroundArtisticFurniture bg-yellow-500 flex justify-between items-center" style={{ backgroundImage: `url(${backgrounds[backgroundIndex]})` }}>
...
export default ArtisticFurniture1
