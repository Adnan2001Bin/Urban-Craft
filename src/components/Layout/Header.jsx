      ...
      >
        <Link to={"/"}>
          <img
            ...
            src="assets/HeaderImage/Studio Shodwe.png"
            alt="Studio Shodwe"
          />
        </Link>
          ...
          <div className="relative group ml-5 ">
            <div className="flex items-center justify-between gap-2">
              <Link to={"/BedRoomCatagoriesPage"}>
                <button className="hover:font-semibold hover:underline flex items-center ">
                  Bedroom
                </button>
              </Link>
              <img
                className="dropdown w-2 h-2 transform transition-transform duration-300 group-hover:rotate-180"
                src="public/assets/HeaderImage/arrow-down.png"
                alt=""
              />
            </div>
        ...
        <div className="w-70 flex">
          <div className="hidden lg:flex lg:items-center lg:bg-gray-100 rounded-3xl lg:w-48 lg:h-10">
            <img
              ...
              src="assets/HeaderImage/search.png"
              alt=""
            />
            <input
              className="bg-gray-100 w-3/4 ml-1 outline-none text-sm"
          ...
          <div onClick={props.onShowNav}>
            <img
              className="w-8 ml-5 lg:hidden"
              src="public/assets/HeaderImage/burger-bar.png"
              alt=""
            />
          </div>
        </div>
