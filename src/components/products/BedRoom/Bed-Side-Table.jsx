      ...
      <div>
          <div className='w-full flex md:justify-end items-center mt-5 mb-5 justify-center'>
              <div className=' flex w-2/4 justify-between pr-5 items-center'>
                  <div>
                      <h1 className='lg:text-3xl text-xl font-semibold text-center'>Bed-Side-Table</h1>
                      <p className='font-extrabold text-gray-900 bg-zinc-950 w-14 h-1'></p>
                  </div>                 
                  <p className='hidden md:block md:text-lg'>Showing {bedSideTableList.length} Products</p>
              </div>
          </div>
          <ProductCardLayout >
              {bedSideTableList}
